      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text('Excelente, elige tu usuario', style: Theme.of(context).textTheme.headline6),
          ...
          SizedBox(height: MAX_HEIGHT * 0.025,),
          FlatButton(
            child: Text('¿Ya tienes cuenta? Ingresa', style: TextStyle(color: Colors.deepPurple, fontStyle: FontStyle.italic, decoration: TextDecoration.underline,),),
    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot){
        return RaisedButton(
          ...
          onPressed: snapshot.hasData ? () => _register(context, b) : null,
        );
      },
    );
  }

  _register (BuildContext context , LoginBloc b) async {
    final Map<String, dynamic> info = await _usrPrv.register(b.email, b.password);
